...
using BottomBarDemo;
using BottomBarDemo.iOS;
using CoreGraphics;
using UIKit;
using Xamarin.Forms;
using Xamarin.Forms.Platform.iOS;

[assembly: ExportRenderer(typeof(TopBarPage), typeof(TopBarPageRenderer))]
namespace BottomBarDemo.iOS
{
	public class TopBarPageRenderer : TabbedRenderer
	{
