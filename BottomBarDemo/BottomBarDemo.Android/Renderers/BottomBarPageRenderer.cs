...
using Xamarin.Forms;
using BottomBarDemo;
using BottomBarDemo.Droid.Renderers;
...
namespace BottomBarDemo.Droid.Renderers
{
    class BottomBarPageRenderer: VisualElementRenderer<BottomBarPage>, IOnTabClickListener
    {
        bool _disposed;
        ...
        {
            if (e.PropertyName == BottomBarPageExtension.BadgeCountProperty.PropertyName)
            {
